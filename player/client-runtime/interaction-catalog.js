(function installPixoInteractionCatalog(globalObject, factory) {
  ...
  const entries = [
    ...
    { type: "draw_circle", instruction: "Draw a circle", icon: "gesture", library: "material-symbols-rounded", mechanic: "draw", inputScope: "viewport", animation: "draw-circle", detection: detection({ response_window_ms: 1800, min_radius_dp: 24, max_closure_gap_dp: 28, rotation_direction: "counterclockwise", place: TOUCH_PLACE }) },
    ...
    { type: "tilt_forward", instruction: "Tilt forward — move the top edge away from you", icon: "smartphone", library: "lucide", mechanic: "motion", capability: "device_motion", animation: "pitch", direction: "forward", badgeIcon: "arrow_down", detection: detection({ response_window_ms: 1200, min_angle_deg: 15, place: SENSOR_PLACE }) },
    { type: "tilt_backward", instruction: "Tilt backward — move the top edge toward you", icon: "smartphone", library: "lucide", mechanic: "motion", capability: "device_motion", animation: "pitch", direction: "backward", badgeIcon: "arrow_up", detection: detection({ response_window_ms: 1200, min_angle_deg: 15, place: SENSOR_PLACE }) },
